...
class Camera360Extractor:
    ...
    def _has_spherical_metadata(
        self, probe_data: dict[str, Any], tags: dict[str, Any]
    ) -> bool:
    ...
    def _detect_brand_model(
        ...
        if make:
            ...
            if "INSTA" in make_upper:
                return "Insta360", model or self._detect_model_from_resolution(
                    probe_data, "insta360"
                )
        ...
        for stream in probe_data.get("streams", []):
            ...
            if "INS" in handler.upper():
                return "Insta360", self._detect_model_from_resolution(
                    probe_data, "insta360"
                )
    ...
    def _detect_model_from_resolution(
        self, probe_data: dict[str, Any], brand: str
    ) -> str | None:
