...
class TranscriptionBackend(ABC):
    ...
    def transcribe(
        ...
        Returns:
            Dict with 'language', 'segments', and optionally 'language_probability'
        """
        pass
...
def extract_transcript(
    ...
    try:
        ...
        if use_language is None:
            ...
            confidence = detect_result.get("language_probability", 0.0)
        ...
        return Transcript(
            language=result.get("language", use_language),
