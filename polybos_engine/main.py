...
from polybos_engine.utils.logging import setup_logging

setup_logging()

# Create the FastAPI application
from polybos_engine.app import create_app
...
from polybos_engine.batch import state as _batch_state
from polybos_engine.batch.models import JOB_TTL_SECONDS  # noqa: F401
from polybos_engine.batch.queue import (  # noqa: F401
    cleanup_expired_batch_jobs as _cleanup_expired_batch_jobs,
)
from polybos_engine.batch.state import (  # noqa: F401
    batch_jobs,
    batch_jobs_lock,
    batch_queue,
    batch_queue_lock,
